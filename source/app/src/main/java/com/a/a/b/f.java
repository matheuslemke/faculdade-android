...
public final class f
{
    ...
    private ae a(Type type, Class class1)
    {
        ...
        if (java/util/Map.isAssignableFrom(class1))
        {
            ...
            if ((type instanceof ParameterizedType) && !java/lang/String.isAssignableFrom(com.a.a.c.a.a(((ParameterizedType)type).getActualTypeArguments()[0]).a()))
            {
                return new h(this);
            } else
            {
