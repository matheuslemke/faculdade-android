...
_L1:
    ...
    {
        throw new e((new StringBuilder()).append(s1).append(" at line ").append(u()).append(" column ").append(v()).toString());
    }
...
_L3:
    ...
    public double k()
    {
        ...
        do
        {
            ...
            {
                throw new e((new StringBuilder()).append("JSON forbids NaN and infinities: ").append(d1).append(" at line ").append(u()).append(" column ").append(v()).toString());
            } else
            {
                l = null;
                i = 0;
