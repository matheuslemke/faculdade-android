...
public class LinearLayoutCompat extends ViewGroup
{
    ...
    public LinearLayoutCompat(Context context, AttributeSet attributeset, int i1)
    {
        ...
        c = 0;
        e = 0x800033;
        context = bc.a(context, attributeset, l.LinearLayoutCompat, i1, 0);
    ...
    private void c(int i1, int j1)
    {
        ...
        for (int k1 = 0; k1 < i1; k1++)
        {
            ...
            w w1 = (w)view.getLayoutParams();
            if (w1.width == -1)
            {
                int i2 = w1.height;
                w1.height = view.getMeasuredHeight();
    ...
    private void d(int i1, int j1)
    {
        ...
        for (int k1 = 0; k1 < i1; k1++)
        {
            ...
            {
                int i2 = w1.width;
                w1.width = view.getMeasuredWidth();
...
label0:
        ...
        w1 = (w)view.getLayoutParams();
        f1 += w1.g;
        if (j7 != 0x40000000 || w1.height != 0 || w1.g <= 0.0F) goto _L5; else goto _L4
_L4:
        int k4;
        int k5;
        k2 = f;
        f = Math.max(k2, w1.topMargin + k2 + w1.bottomMargin);
        k5 = 1;
        k4 = j2;
_L7:
        if (k7 >= 0 && k7 == i3 + 1)
...
_L5:
        ...
        k4 = f;
        f = Math.max(k4, k4 + l5 + w1.topMargin + w1.bottomMargin + b(view));
        k4 = j2;
        k5 = k2;
        if (flag)
        {
...
_L6:
        ...
        j3 = w1.leftMargin;
        j3 = w1.rightMargin + j3;
        i6 = view.getMeasuredWidth() + j3;
        k6 = Math.max(l1, i6);
        j6 = bi.a(k1, bb.g(view));
        if (i2 != 0 && w1.width == -1)
        {
            i2 = 1;
        } else
...
label1:
        {
                ...
                if (flag && (j7 == 0x80000000 || j7 == 0))
                {
                    ...
                    while (i3 < l6) 
                    {
                        ...
                        } else
                        {
                            ...
                            k4 = f;
                            k5 = w1.topMargin;
                            f = Math.max(k4, w1.bottomMargin + (k4 + j2 + k5) + b(view));
                        }
                        i3++;
                    }
                }
                f = f + (getPaddingTop() + getPaddingBottom());
                k5 = bb.a(Math.max(f, getSuggestedMinimumHeight()), j1, 0);
                i3 = (0xffffff & k5) - f;
                ...
                while (i3 < l6) 
                {
                    ...
                    } else
                    {
                        ...
                        if (f2 > 0.0F)
                        {
                            ...
                            i6 = getChildMeasureSpec(i1, getPaddingLeft() + getPaddingRight() + w1.leftMargin + w1.rightMargin, w1.width);
                            if (w1.height != 0 || j7 != 0x40000000)
                            {
                            ...
                            k1 = bi.a(k1, bb.g(view) & 0xffffff00);
                            l2 = k2 - k3;
                            k2 = k1;
                            f1 -= f2;
                            k1 = l2;
                        ...
                        k3 = w1.leftMargin + w1.rightMargin;
                        ...
                        k4 = w1.topMargin;
                        f = Math.max(i2, w1.bottomMargin + (k3 + i2 + k4) + b(view));
                        i2 = l2;
                        l2 = k1;
                        k1 = k2;
                        k2 = l2;
            ...
            setMeasuredDimension(bb.a(Math.max(l1 + (getPaddingLeft() + getPaddingRight()), getSuggestedMinimumWidth()), i1, k1), k5);
            if (j3 != 0)
            {
                c(l6, j1);
            }
        ...
        if (flag && j7 != 0x40000000)
        {
            ...
            do
            {
                ...
                view = b(k2);
                if (view != null && view.getVisibility() != 8 && ((w)view.getLayoutParams()).g > 0.0F)
                {
...
_L13:
        ...
        j1 += w1.bottomMargin + l3 + b(view);
        i1 = a(view, i1) + i1;
          goto _L9
_L11:
        k1 = ((j2 - i2 - l2 - k3) / 2 + i2 + w1.leftMargin) - w1.rightMargin;
          goto _L13
        k1 = j2 - k2 - k3 - w1.rightMargin;
          goto _L13
_L6:
        return;
...
_L14:
    ...
    void a(Canvas canvas)
    {
        ...
        for (int i1 = 0; i1 < k1; i1++)
        {
            ...
            {
                w w1 = (w)view.getLayoutParams();
                a(canvas, view.getTop() - w1.topMargin - m);
            }
        }
        ...
        if (c(k1))
        {
            ...
            {
                w w2 = (w)view1.getLayoutParams();
                j1 = view1.getBottom();
                j1 = w2.bottomMargin + j1;
            }
            a(canvas, j1);
        }
    }
    ...
    public w b(AttributeSet attributeset)
    {
        return new w(getContext(), attributeset);
    }

    protected w b(android.view.ViewGroup.LayoutParams layoutparams)
    {
    ...
    void b(int i1, int j1)
    {
        ...
        while (k3 < l6) 
        {
            ...
            } else
            {
                ...
                w w1 = (w)view1.getLayoutParams();
                f1 += w1.g;
                int k4;
                int k5;
                int i6;
                if (j7 == 0x40000000 && w1.width == 0 && w1.g > 0.0F)
                {
                    int j6;
                    int k6;
                    if (flag)
                    {
                        f = f + (w1.leftMargin + w1.rightMargin);
                    } else
                    {
                        k4 = f;
                        f = Math.max(k4, w1.leftMargin + k4 + w1.rightMargin);
                    }
                    if (flag1)
                    {
                ...
                } else
                {
                    ...
                    if (flag)
                    {
                        f = f + (w1.leftMargin + i6 + w1.rightMargin + b(view1));
                    } else
                    {
                        k4 = f;
                        f = Math.max(k4, k4 + i6 + w1.leftMargin + w1.rightMargin + b(view1));
                    }
                    k4 = j2;
                    k5 = k2;
                    if (flag2)
                ...
                i3 = w1.topMargin;
                i3 = w1.bottomMargin + i3;
                i6 = view1.getMeasuredHeight() + i3;
                j6 = bi.a(l1, bb.g(view1));
                if (flag1)
                {
        ...
        if (flag2 && (j7 == 0x80000000 || j7 == 0))
        {
            ...
            while (i2 < l6) 
            {
                ...
                {
                    w1 = (w)view1.getLayoutParams();
                    if (flag)
                    {
                        k4 = f;
                        k5 = w1.leftMargin;
                        f = w1.rightMargin + (k5 + j2) + b(view1) + k4;
                    } else
                    {
                        k4 = f;
                        k5 = w1.leftMargin;
                        f = Math.max(k4, w1.rightMargin + (k4 + j2 + k5) + b(view1));
                    }
                }
                i2++;
            }
        ...
        i6 = bb.a(Math.max(f, getSuggestedMinimumWidth()), i1, 0);
        i2 = (0xffffff & i6) - f;
                ...
                if (view1 != null)
                {
                    ...
                    } else
                    {
                        ...
                        if (f2 > 0.0F)
                        {
                            ...
                            j3 = j2 - k3;
                            k4 = getChildMeasureSpec(j1, getPaddingTop() + getPaddingBottom() + w1.topMargin + w1.bottomMargin, w1.height);
                            if (w1.width != 0 || j7 != 0x40000000)
                            {
                            ...
                            k2 = bi.a(k2, bb.g(view1) & 0xff000000);
                            f1 -= f2;
                            j2 = j3;
                        }
                        if (flag)
                        {
                            f = f + (view1.getMeasuredWidth() + w1.leftMargin + w1.rightMargin + b(view1));
                        } else
                        {
                            j3 = f;
                            f = Math.max(j3, view1.getMeasuredWidth() + j3 + w1.leftMargin + w1.rightMargin + b(view1));
                        }
                        if (i7 != 0x40000000 && w1.height == -1)
                        {
                            j3 = 1;
                        ...
                        k5 = w1.topMargin + w1.bottomMargin;
...
_L4:
        ...
        setMeasuredDimension(0xff000000 & k1 | i6, bb.a(Math.max(i2 + (getPaddingTop() + getPaddingBottom()), getSuggestedMinimumHeight()), j1, k1 << 16));
        if (i3 != 0)
        {
            d(l6, i1);
        }
...
_L12:
        ...
        if (j2 != -1)
        {
          ...
          goto _L15
_L11:
        i1 = ((i3 - k2 - k3 - l4) / 2 + k2 + w1.topMargin) - w1.bottomMargin;
          goto _L15
        l2 = i3 - j3 - l4 - w1.bottomMargin;
        i1 = l2;
        if (j2 != -1)
        {
    ...
    void b(Canvas canvas)
    {
        ...
        while (i1 < l1) 
        {
            ...
            if (view != null && view.getVisibility() != 8 && c(i1))
            {
                ...
                {
                    k1 = view.getRight();
                    k1 = w1.rightMargin + k1;
                } else
                {
                    k1 = view.getLeft() - w1.leftMargin - l;
                }
                b(canvas, k1);
            }
            i1++;
        ...
        if (c(l1))
        {
            ...
            } else
            {
                ...
                if (flag)
                {
                    j1 = view1.getLeft() - w2.leftMargin - l;
                } else
                {
                    j1 = view1.getRight();
                    j1 = w2.rightMargin + j1;
                }
            }
            b(canvas, j1);
        }
...
_L7:
    ...
    //                   80: 147;
           goto _L6 _L8 _L9
_L6:
        return ((w)view.getLayoutParams()).topMargin + i1 + j1;
_L9:
