...
class ao extends Drawable
{
    ...
    ao(Resources resources, int i1, float f1, float f2, float f3)
    {
        n = true;
        q = true;
        r = false;
        o = resources.getColor(b.cardview_shadow_start_color);
        p = resources.getColor(b.cardview_shadow_end_color);
        b = resources.getDimensionPixelSize(c.cardview_compat_inset_shadow);
        d = new Paint(5);
        d.setColor(i1);
        e = new Paint(5);
