    ...
    implements android.view.View.OnClickListener
{
    ...
    public au(Context context, SearchView searchview, SearchableInfo searchableinfo, WeakHashMap weakhashmap)
    {
...
_L1:
    ...
    public View a(Context context, Cursor cursor, ViewGroup viewgroup)
    {
        ...
        context.setTag(new av(context));
        ((ImageView)context.findViewById(g.edit_query)).setImageResource(o);
        return context;
    }
...
_L3:
    ...
    public void a(View view, Context context, Cursor cursor)
    {
        ...
        if (((av) (context)).a != null)
        {
            view = a(cursor, s);
            a(((av) (context)).a, ((CharSequence) (view)));
        }
        if (((av) (context)).b == null) goto _L2; else goto _L1
_L1:
        view = a(cursor, u);
        if (view != null)
        {
...
_L3:
        if (((av) (context)).a != null)
        {
            ((av) (context)).a.setSingleLine(false);
            ((av) (context)).a.setMaxLines(2);
        }
_L6:
        a(((av) (context)).b, ((CharSequence) (view)));
_L2:
        if (((av) (context)).c != null)
        {
            a(((av) (context)).c, e(cursor), 4);
        }
        if (((av) (context)).d != null)
        {
            a(((av) (context)).d, f(cursor), 8);
        }
        if (q == 2 || q == 1 && (i & 1) != 0)
        {
            ((av) (context)).e.setVisibility(0);
            ((av) (context)).e.setTag(((av) (context)).a.getText());
            ((av) (context)).e.setOnClickListener(this);
            return;
        } else
        {
            ((av) (context)).e.setVisibility(8);
            return;
        }
_L4:
        if (((av) (context)).a != null)
        {
            ((av) (context)).a.setSingleLine(true);
            ((av) (context)).a.setMaxLines(1);
        }
...
_L5:
    ...
    public View getView(int i, View view, ViewGroup viewgroup)
    {
        ...
        catch (View view)
        {
            ...
            if (viewgroup != null)
            {
                ((av)viewgroup.getTag()).a.setText(view.toString());
            }
            return viewgroup;
        }
        return view;
