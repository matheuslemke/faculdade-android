    ...
    implements android.content.DialogInterface.OnClickListener
{
    ...
    SpinnerCompat(Context context, AttributeSet attributeset, int i, int j)
    {
        ...
        K = new Rect();
        bc1 = bc.a(context, attributeset, l.Spinner, i, 0);
        setBackgroundDrawable(bc1.a(l.Spinner_android_background));
        k = j;
        if (j == -1)
        {
            k = bc1.a(l.Spinner_spinnerMode, 0);
        }
        k;
    ...
    //                   1 188;
           goto _L1 _L2 _L3
_L1:
        I = bc1.a(l.Spinner_android_gravity, 17);
        G.a(bc1.c(l.Spinner_prompt));
        J = bc1.a(l.Spinner_disableChildrenWhenDisabled, false);
        bc1.b();
        if (H != null)
        {
            G.a(H);
...
_L3:
        context = new ap(this, context, attributeset, i);
        E = bc1.e(l.Spinner_android_dropDownWidth, -2);
        context.a(bc1.a(l.Spinner_android_popupBackground));
        G = context;
        F = new al(this, this, context);
...
_L6:
    ...
    void a(android.support.v7.internal.widget.q q1)
    {
        super.setOnItemClickListener(q1);
    }
    ...
    public void a(SpinnerAdapter spinneradapter)
    {
        ...
        if (G != null)
        {
            G.a(new ao(spinneradapter));
            return;
        } else
        {
            H = new ao(spinneradapter);
            return;
        }
    }
...
_L3:
    ...
    public void setOnItemClickListener(android.support.v7.internal.widget.q q1)
    {
    ...
    private class SavedState extends AbsSpinnerCompat.SavedState
    {
        ...
        SavedState(Parcel parcel, al al1)
        {
            this(parcel);
        }
