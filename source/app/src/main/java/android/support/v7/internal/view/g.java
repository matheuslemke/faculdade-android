...
class g
{
    ...
    private void a(MenuItem menuitem)
    {
        ...
        if (w != null)
        {
            ah.a(menuitem, (View)a(w, android.support.v7.internal.view.e.b(), android.support.v7.internal.view.e.d(a)));
        } else
        {
            flag = false;
        }
    ...
    public void b(AttributeSet attributeset)
    {
        ...
        if (i1 != 0 && v == 0 && w == null)
        {
            z = (n)a(x, android.support.v7.internal.view.e.a(), android.support.v7.internal.view.e.b(a));
        } else
        {
            if (i1 != 0)
            {
