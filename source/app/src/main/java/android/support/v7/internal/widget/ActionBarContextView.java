    ...
    implements df
{
    ...
    public ActionBarContextView(Context context, AttributeSet attributeset, int i1)
    {
        ...
        context = android.support.v7.internal.widget.bc.a(context, attributeset, l.ActionMode, i1, 0);
...
label0:
    ...
    private h g()
    {
        bb.a(l, -l.getWidth() - ((android.view.ViewGroup.MarginLayoutParams)l.getLayoutParams()).leftMargin);
        cp cp1 = bb.j(l).b(0.0F);
        cp1.a(200L);
        cp1.a(this);
        cp1.a(new DecelerateInterpolator());
        h h1 = new h();
        h1.a(cp1);
        if (c != null)
        {
    ...
    private h h()
    {
        cp cp1 = bb.j(l).b(-l.getWidth() - ((android.view.ViewGroup.MarginLayoutParams)l.getLayoutParams()).leftMargin);
        cp1.a(200L);
        cp1.a(this);
        cp1.a(new DecelerateInterpolator());
        h h1 = new h();
...
label0:
    ...
    {
        flag = android.support.v7.internal.widget.bi.a(this);
        int i2;
        int j2;
        int k2;
        if (flag)
