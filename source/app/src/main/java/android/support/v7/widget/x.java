...
public class x
{
    ...
    public x(Context context, AttributeSet attributeset, int i1)
    {
        this(context, attributeset, i1, 0);
    }

    public x(Context context, AttributeSet attributeset, int i1, int j1)
    {
        g = -2;
        h = -2;
        l = 0;
        ...
        typedarray.recycle();
        d = new u(context, attributeset, i1);
        d.setInputMethodMode(1);
        D = android.support.v4.e.f.a(c.getResources().getConfiguration().locale);
    }
...
_L1:
        ...
        int l1;
        obj1 = c;
        z = new android.support.v7.widget.z(this);
        boolean flag;
        if (!C)
        {
            flag = true;
        ...
        f.setOnItemSelectedListener(new aa(this));
...
_L2:
        ...
        android.support.v4.widget.z.a(d, d(), i, j, l);
        f.setSelection(-1);
