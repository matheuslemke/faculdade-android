...
public class ActionMenuItemView extends v
    implements aa, k, android.view.View.OnClickListener, android.view.View.OnLongClickListener
{
    ...
    public ActionMenuItemView(Context context, AttributeSet attributeset, int i1)
    {
        ...
        attributeset = context.obtainStyledAttributes(attributeset, l.ActionMenuItemView, i1, 0);
        i = attributeset.getDimensionPixelSize(l.ActionMenuItemView_android_minWidth, 0);
