...
//            w, h, i, j, 
//            k, x, ActionBarContainer, m, 
//            ContentFrameLayout, bi, l
    ...
    implements w
{
    ...
    static cp a(ActionBarOverlayLayout actionbaroverlaylayout, cp cp1)
    {
        actionbaroverlaylayout.y = cp1;
        return cp1;
    }
    ...
    static cp b(ActionBarOverlayLayout actionbaroverlaylayout, cp cp1)
    {
        actionbaroverlaylayout.z = cp1;
        return cp1;
    }

    static df b(ActionBarOverlayLayout actionbaroverlaylayout)
    {
    ...
    static df e(ActionBarOverlayLayout actionbaroverlaylayout)
    {
    ...
    public void draw(Canvas canvas)
    {
        ...
        if (h != null && !i)
        {
            ...
            {
                i1 = (int)((float)f.getBottom() + bb.h(f) + 0.5F);
            } else
            {
                i1 = 0;
            }
    ...
    protected boolean fitSystemWindows(Rect rect)
    {
        ...
        s.set(rect);
        android.support.v7.internal.widget.bi.a(this, s, p);
        if (!q.equals(p))
        {
            q.set(p);
            flag = true;
    ...
    protected void onMeasure(int i1, int j1)
    {
        ...
        int i2 = android.support.v7.internal.widget.bi.a(0, bb.g(f));
        if (e != null)
        {
            ...
            i2 = android.support.v7.internal.widget.bi.a(i2, bb.g(e));
        }
        boolean flag;
        if ((bb.k(this) & 0x100) != 0)
        {
        ...
        i2 = android.support.v7.internal.widget.bi.a(i2, bb.g(d));
        j2 = getPaddingLeft();
        k2 = getPaddingRight();
        l1 = Math.max(l1 + (getPaddingTop() + getPaddingBottom()), getSuggestedMinimumHeight());
        setMeasuredDimension(bb.a(Math.max(k1 + (j2 + k2), getSuggestedMinimumWidth()), i1, i2), bb.a(l1, j1, i2 << 16));
    }
    ...
    public void setWindowCallback(android.support.v7.internal.a.a a1)
    {
        c();
        g.a(a1);
    }
