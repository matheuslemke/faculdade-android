...
//            u, x, p, Fragment, 
//            e, z, as, FragmentManagerState, 
//            FragmentState, BackStackState, ct, az, 
//            t, aa, y, v, 
//            ab, ai
    ...
    implements android.view.LayoutInflater.Factory
{
    ...
    public int a(android.support.v4.app.e e1)
    {
        this;
...
_L3:
    ...
    public void a(int i1, int j1)
    {
        ...
        {
            a(((Runnable) (new z(this, i1, j1))), false);
            return;
        }
    }
    ...
    public void a(int i1, android.support.v4.app.e e1)
    {
        this;
        JVM INSTR monitorenter ;
        int k1;
        ...
        if (((FragmentManagerState) (parcelable = (FragmentManagerState)parcelable)).a != null)
        {
            ...
            if (((FragmentManagerState) (parcelable)).c != null)
            {
                ...
                while (i2 < ((FragmentManagerState) (parcelable)).c.length) 
                {
                    ...
                    if (a)
                    {
                        Log.v("FragmentManager", (new StringBuilder()).append("restoreAllState: back stack #").append(i2).append(" (index ").append(((android.support.v4.app.e) (arraylist)).o).append("): ").append(arraylist).toString());
                        arraylist.a("  ", new PrintWriter(new e("FragmentManager")), false);
                    }
                    i.add(arraylist);
                    if (((android.support.v4.app.e) (arraylist)).o >= 0)
                    {
                        a(((android.support.v4.app.e) (arraylist)).o, ((android.support.v4.app.e) (arraylist)));
                    }
                    i2++;
                }
            } else
...
_L4:
        ...
        if (!fragment.P)
        {
            throw new ct((new StringBuilder()).append("Fragment ").append(fragment).append(" did not call through to super.onAttach()").toString());
        }
        if (fragment.F == null)
        {
            o.a(fragment);
            ...
            if (!fragment.y)
            {
                ...
                if (fragment.H != 0)
                {
                    ...
                    if (obj1 == null)
                    {
                        ...
                        if (!fragment.A)
                        {
                            a(((RuntimeException) (new IllegalArgumentException((new StringBuilder()).append("No view found for id 0x").append(Integer.toHexString(fragment.H)).append(" (").append(fragment.l().getResourceName(fragment.H)).append(") for fragment ").append(fragment).toString()))));
                            obj = obj1;
                        }
                    }
                } else
        ...
        if (i1 < 2)
        {
            ...
            if (fragment.S != null && fragment.R != null)
            {
                ...
                if (obj != null)
                {
                    ...
                    fragment.m = i1;
                    ((Animation) (obj)).setAnimationListener(new aa(this, fragment));
...
_L14:
        ...
        if (!fragment.P)
        {
            throw new ct((new StringBuilder()).append("Fragment ").append(fragment).append(" did not call through to super.onDetach()").toString());
        }
        i2 = i1;
        if (!flag)
        {
...
_L15:
    ...
    public void a(p p1, t t1, Fragment fragment)
    {
        if (o != null)
        {
    ...
    public void a(String s1, FileDescriptor filedescriptor, PrintWriter printwriter, String as1[])
    {
        ...
        if (i != null)
        {
            ...
            if (j3 > 0)
            {
                ...
                {
                    android.support.v4.app.e e1 = (android.support.v4.app.e)i.get(l1);
                    printwriter.print(s1);
                    printwriter.print("  #");
                    printwriter.print(l1);
                    printwriter.print(": ");
                    printwriter.println(e1.toString());
                    e1.a(s2, filedescriptor, printwriter, as1);
                }
...
_L4:
        ...
        filedescriptor = (android.support.v4.app.e)k.get(i2);
        printwriter.print(s1);
        printwriter.print("  #");
...
_L5:
        handler = (android.support.v4.app.e)i.remove(i1);
        s1 = new SparseArray();
...
_L6:
        ...
        do
        {
            ...
            handler = (android.support.v4.app.e)i.get(j1);
            if (s1 == null || !s1.equals(handler.d()))
            {
                ...
                k1 = j1;
                if (i1 != ((android.support.v4.app.e) (handler)).o)
                {
                    continue; /* Loop/switch isn't completed */
                }
            }
        ...
        do
        {
            ...
            handler = (android.support.v4.app.e)i.get(l1);
            if (s1 != null && s1.equals(handler.d()) || i1 >= 0 && i1 == ((android.support.v4.app.e) (handler)).o)
            {
                continue; /* Loop/switch isn't completed */
            }
            l1--;
...
_L7:
        ...
        for (i1 = 0; i1 <= j1; i1++)
        {
            ((android.support.v4.app.e)s1.get(i1)).a(sparsearray1, sparsearray2);
        }
        ...
        while (i1 <= j1) 
        {
            ...
            android.support.v4.app.e e1 = (android.support.v4.app.e)s1.get(i1);
            boolean flag;
            if (i1 == j1)
            {
                flag = true;
...
label0:
    ...
    void b(android.support.v4.app.e e1)
    {
        if (i == null)
        {
            i = new ArrayList();
...
label0:
        ...
        if (i != null)
        {
            ...
            if (i2 > 0)
            {
                ...
                do
                {
                    ...
                    abackstackstate1[j1] = new BackStackState(this, (android.support.v4.app.e)i.get(j1));
                    if (a)
                    {
    ...
    public View onCreateView(String s1, Context context, AttributeSet attributeset)
    {
        ...
        s1 = context.obtainStyledAttributes(attributeset, ab.a);
        if (s2 == null)
        {
            s2 = s1.getString(0);
        }
        ...
        } else
        {
            ...
            if (!((Fragment) (obj)).M)
            {
                ((Fragment) (obj)).a(o, attributeset, ((Fragment) (obj)).n);
            }
            s1 = ((String) (obj));
        }
        if (n < 1 && ((Fragment) (s1)).y)
        {
            a(s1, 1, 0, 0, false);
        } else
        {
    ...
    android.view.LayoutInflater.Factory v()
    {
        return this;
    }
