...
public class au
{
    ...
    private static final Interpolator v = new av();
    private int a;
    private int b;
    private int c;
    private float d[];
    ...
    private int p;
    private af q;
    private final android.support.v4.widget.aw r;
    private View s;
    private boolean t;
...
_L6:
    ...
    {
        int j1 = ap.c(motionevent);
        for (int i1 = 0; i1 < j1; i1++)
        {
            int k1 = ap.b(motionevent, i1);
            float f1 = ap.c(motionevent, i1);
            float f2 = ap.d(motionevent, i1);
            f[k1] = f1;
            g[k1] = f2;
        }
    ...
    private void h()
    {
        ...
        a(a(aw.a(l, c), n, m), a(aw.b(l, c), n, m));
    }
    ...
    public boolean a(int i1, int j1)
    {
        ...
        {
            return a(i1, j1, (int)aw.a(l, c), (int)aw.b(l, c));
        }
    }
...
_L2:
        ...
        if ((p & j1) != 0)
        {
          ...
          goto _L7
_L5:
        j1 = ap.b(motionevent, i1);
        float f2 = ap.c(motionevent, i1);
        float f5 = ap.d(motionevent, i1);
        a(f2, f5, j1);
        if (a == 0)
        {
            i1 = h[j1];
...
_L8:
        l1 = ap.b(motionevent, i1);
        float f3 = ap.c(motionevent, i1);
        float f6 = ap.d(motionevent, i1);
        f7 = f3 - d[l1];
        f8 = f6 - e[l1];
...
_L6:
        float f2;
        float f4;
        i1 = ap.b(motionevent, k1);
        f2 = ap.c(motionevent, k1);
        f4 = ap.d(motionevent, k1);
        a(f2, f4, i1);
        if (a != 0)
        {
...
_L4:
        if (a == 1)
        {
            i1 = ap.a(motionevent, c);
            f2 = ap.c(motionevent, i1);
            f4 = ap.d(motionevent, i1);
            i1 = (int)(f2 - f[c]);
            j1 = (int)(f4 - g[c]);
